...
class BreedsViewModelTest {
    ...
    @Test
    fun `GIVEN successful pets fetch WHEN viewmodel is initialized THEN updates pets state with success`() =
        runTest {
            // Given
            val mockPets =
                listOf(
    ...
    @Test
    fun `GIVEN error during pets fetch WHEN viewmodel is initialized THEN updates pets state with error`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN loading state WHEN pets are being fetched THEN updates pets state with loading`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN search query WHEN onSearchQueryChanged is called THEN updates search query and filters pets`() =
        runTest {
            // Given
            val mockPets =
                listOf(
    ...
    @Test
    fun `GIVEN empty search query WHEN onSearchQueryChanged is called THEN shows all pets`() =
        runTest {
            // Given
            val mockPets =
                listOf(
    ...
    @Test
    fun `GIVEN pet id WHEN onToggleFavorite is called THEN calls toggle favorite use case`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN refresh request WHEN onRefresh is called THEN calls refresh use case and updates refreshing state`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN lifespan range WHEN onLifeSpanRangeChanged is called THEN updates lifespan range and filters pets`() =
        runTest {
            // Given
            val mockPets =
                listOf(
    ...
    @Test
    fun `GIVEN new pet type WHEN setPetType is called THEN calls preferences manager to save pet type`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN pagination request WHEN loadNextPage is called THEN calls refresh use case with next page`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN loading more in progress WHEN loadNextPage is called THEN does not make additional request`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN search query is active WHEN onRefresh is called THEN calls refresh use case with search query`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN search query is active WHEN loadNextPage is called THEN does not paginate`() =
        runTest {
            // Given
            breedsViewModel =
                BreedsViewModel(
    ...
    @Test
    fun `GIVEN lifespan filter is active WHEN loadNextPage is called THEN does not paginate`() =
        runTest {
            // Given
            breedsViewModel =
                BreedsViewModel(
    ...
    @Test
    fun `GIVEN pet type changes WHEN setPetType is called THEN triggers reload with new pet type`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN search and lifespan filters WHEN both are applied THEN filters by both criteria`() =
        runTest {
            // Given
            val mockPets =
                listOf(
    ...
    @Test
    fun `GIVEN pagination error WHEN loadNextPage is called THEN stops loading but maintains current page`() =
        runTest {
            // Given
