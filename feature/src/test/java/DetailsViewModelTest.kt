...
class DetailsViewModelTest {
    ...
    @Test
    fun `GIVEN valid pet id WHEN viewmodel is initialized THEN loads pet details and images`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN pet not found WHEN viewmodel is initialized THEN pet remains null`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN error loading images WHEN viewmodel is initialized THEN falls back to cached images`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN favorite pet WHEN onToggleFavorite is called THEN toggles favorite status and reloads pet`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN loading images WHEN images are being fetched THEN isLoadingImages is true during fetch`() =
        runTest {
            // Given
            val mockPet = createMockPet(testPetId, "Persian", PetType.CAT)
    ...
    @Test
    fun `GIVEN pet with no cached images WHEN API returns empty list THEN additionalImages is empty`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN no petId in SavedStateHandle WHEN viewmodel is initialized THEN throws exception`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN multiple rapid toggle calls WHEN onToggleFavorite is called multiple times THEN all calls are processed`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN pet with cached images WHEN API returns new images THEN updates with new images`() =
        runTest {
            // Given
