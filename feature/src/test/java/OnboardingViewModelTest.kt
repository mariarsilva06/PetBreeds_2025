...
class OnboardingViewModelTest {
    ...
    @Test
    fun `GIVEN cat pet type WHEN selectPetType is called THEN saves cat preference`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN dog pet type WHEN selectPetType is called THEN saves dog preference`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN multiple pet type calls WHEN selectPetType is called multiple times THEN saves each preference`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN save error WHEN selectPetType is called THEN handles exception gracefully`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN rapid pet type changes WHEN selectPetType is called rapidly THEN saves only last selection`() =
        runTest {
            // Given
