...
class PetRepositoryImpl
    ...
    constructor(
            ...
            try {
                ...
                when {
                    ...
                    !query.isNullOrBlank() -> {
                        val favoriteIds =
                            petDao
                                .getFavoritePetsByType(petType)
                                .first()
                                .map { it.id }
                                .toSet()
                        val petsWithFavorites =
                            pets.map { newPet ->
        ...
        override suspend fun getPetDetails(petId: String): Pet? = petDao.getPetById(petId)?.toDomain()
