...
class GetPetImagesUseCaseTest {
    ...
    @Test
    fun `GIVEN repository returns images WHEN invoke is called THEN returns those images`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN repository throws exception WHEN invoke is called THEN returns empty list`() =
        runTest {
            // Given
            val petId = "test-pet-id"
    ...
    @Test
    fun `GIVEN different pet types WHEN invoke is called THEN calls repository with correct pet type`() =
        runTest {
            // Given
            val catPetId = "cat-id"
            val dogPetId = "dog-id"
