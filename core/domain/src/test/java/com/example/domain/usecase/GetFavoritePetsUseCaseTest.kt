...
class GetFavoritePetsUseCaseTest {
    ...
    @Test
    fun `GIVEN no favorite pets WHEN invoke is called THEN returns empty state`() =
        runTest {
            // Given
    ...
    @Test
    fun `GIVEN favorite pets exist WHEN invoke is called THEN returns success state with correct data`() =
        runTest {
            // Given
            val favoritePets =
                listOf(
    ...
    @Test
    fun `GIVEN pets with range lifespan WHEN invoke is called THEN calculates correct average from ranges`() =
        runTest {
            // Given
            val favoritePets =
                listOf(
    ...
    @Test
    fun `GIVEN pets with single number lifespan WHEN invoke is called THEN calculates correct average from numbers`() =
        runTest {
            // Given
            val favoritePets =
                listOf(
    ...
    @Test
    fun `GIVEN pets with years suffix WHEN invoke is called THEN calculates correct average removing years suffix`() =
        runTest {
            // Given
            val favoritePets =
                listOf(
    ...
    @Test
    fun `GIVEN pets with mixed lifespan formats WHEN invoke is called THEN calculates correct average from mixed formats`() =
        runTest {
            // Given
            val favoritePets =
                listOf(
    ...
    @Test
    fun `GIVEN pets with invalid lifespan format WHEN invoke is called THEN ignores invalid values in calculation`() =
        runTest {
            // Given
            val favoritePets =
                listOf(
    ...
    @Test
    fun `GIVEN single favorite pet WHEN invoke is called THEN returns correct single pet data`() =
        runTest {
            // Given
            val singlePet =
                listOf(
    ...
    @Test
    fun `GIVEN dog pet type WHEN invoke is called THEN calls repository with correct pet type`() =
        runTest {
            // Given
            val dogPets =
                listOf(
